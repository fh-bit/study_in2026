...
Lx = 2*pi; Ly = 2*pi;
Nx = 128;  Ny = 128;
dt = 0.01; T_end = 10.0; % 注意：这里用了较大的 dt
epsilon = 0.05; 
kappa = 2.0;            % 稳定化参数 (Stabilizer)
...
% --- 初始化视频对象 ---
v = VideoWriter('Allen_Cahn_Evolution.mp4', 'MPEG-4');
v.FrameRate = 10; % 每秒显示10帧
open(v);
...
% --- 关闭视频对象 ---
close(v);
fprintf('视频保存成功！文件名：Allen_Cahn_Evolution.mp4\n');